...
# Robust directory resolution for local, serverless, and Vercel environments
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
TEMPLATES_DIR = os.path.join(BASE_DIR, "templates")
STATIC_DIR = os.path.join(BASE_DIR, "static")

if not os.path.exists(TEMPLATES_DIR):
    parent_templates = os.path.join(os.path.dirname(BASE_DIR), "templates")
...
def get_db_connection():
    ...
    db_path = os.path.join(tempfile.gettempdir(), "wall_trust.db") if is_vercel else os.path.join(BASE_DIR, "wall_trust.db")
